# Generated by Django 4.2.7 on 2024-02-09 11:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tf2folio', '0002_remove_item_estimated_price_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scm_key_price_dollars', models.DecimalField(decimal_places=2, default='2.2', max_digits=10)),
                ('paypal_key_price_dollars', models.DecimalField(decimal_places=2, default='1.7', max_digits=10)),
            ],
        ),
        migrations.RemoveField(
            model_name='user',
            name='default_paypal_currency',
        ),
        migrations.RemoveField(
            model_name='user',
            name='default_scm_currency',
        ),
        migrations.AddField(
            model_name='user',
            name='market_settings',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tf2folio.usermarketsettings'),
        ),
    ]
